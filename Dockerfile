...
COPY --chown=5000:5000 --from=builder /go/src/github.com/vulcanize/mcd_transformers/$config_file config.toml
COPY --chown=5000:5000 --from=builder /go/src/github.com/vulcanize/mcd_transformers/dockerfiles/startup_script.sh .
...
COPY --chown=5000:5000 --from=builder /go/src/github.com/vulcanize/vulcanizedb/vulcanizedb vulcanizedb
